...
local changelog = [[
Version 134:
-removed engine_no_focus_sleep convar override since a gmod update blocked it and caused an error
-fixed issue that would cause player hand position to be slightly off on some models
-playermodel eye height is no longer hardcoded which means it's now possible to use playermodels that are shorter or taller than default
-added convar: vrmod_charactereyeheight
-added convar: vrmod_characterheadtohmddist
-updated height adjustment menu to work with new changes
